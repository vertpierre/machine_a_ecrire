...
((t) => {
  ...
  (t.cleanData = ((e) => (i) => {
    ...
    (t.widget = (e, i, s) => {
      ...
      return (
        ...
        (t.expr[":"][l.toLowerCase()] = (e) => !!t.data(e, l)),
        (t[h] = t[h] || {}),
        (n = t[h][e]),
        (o = t[h][e] =
          function (t, e) {
    ...
    (t.Widget.prototype = {
      ...
      _untrackClassesElement: function (e) {
        t.each(this.classesElementLookup, (s, n) => {
          -1 !== t.inArray(e.target, n) &&
            (this.classesElementLookup[s] = t(n.not(e.target).get()));
        });
      },
    ...
    t.extend(t.expr[":"], {
      data: t.expr.createPseudo
        ? t.expr.createPseudo((e) => (i) => !!t.data(i, e))
        : (e, i, s) => !!t.data(e, s[3]),
    }),
    t.fn.extend({
      disableSelection: (() => {
  ...
  (t.effects = { effect: {} }),
        ...
        h = [
          {
            ...
            parse: (t) => [t[1], t[2], t[3], t[4]],
          },
          {
            re: /rgba?\(\s*(\d+(?:\.\d+)?)%\s*,\s*(\d+(?:\.\d+)?)%\s*,\s*(\d+(?:\.\d+)?)%\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,
            parse: (t) => [2.55 * t[1], 2.55 * t[2], 2.55 * t[3], t[4]],
          },
          {
          ...
          },
          {
            ...
            space: "hsla",
            parse: (t) => [t[1], t[2] / 100, t[3] / 100, t[4]],
          },
        ],
        l = (t.Color = (e, i, s, n) => new t.Color.fn.parse(e, i, s, n)),
        c = {
          rgba: {
            props: {
              red: { idx: 0, type: "byte" },
              ...
              "string" === d
                ...
                : "array" === d
                  ...
                  : "object" === d
                    ? (n instanceof l
                        ? f(c, (t, e) => {
                            n[e.cache] && (this[e.cache] = n[e.cache].slice());
                          })
                        : f(c, (e, s) => {
                            var o = s.cache;
                            f(s.props, (t, e) => {
                              if (!this[o] && s.to) {
                                ...
                                this[o] = s.to(this._rgba);
                              }
                              this[o][e.idx] = i(n[t], e, !0);
                            }),
                              this[o] &&
                                0 > t.inArray(null, this[o].slice(0, 3)) &&
                                ((this[o][3] = 1),
                                s.from && (this._rgba = s.from(this[o])));
                          }),
                      this)
                    : e
            );
          ...
          is: function (t) {
            ...
            return (
              f(c, (t, o) => {
                ...
                return (
                  r &&
                    ((a = this[o.cache] || (o.to && o.to(this._rgba)) || []),
                    f(o.props, (t, i) =>
                      null != r[i.idx] ? (s = r[i.idx] === a[i.idx]) : e,
                    )),
                  s
                );
              }),
    ...
    (() => {
      ...
      t.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], (t, i) => {
        ...
        t.each(e, (e, i) => {
          (t.easing["easeIn" + e] = i),
            (t.easing["easeOut" + e] = (t) => 1 - i(1 - t)),
            (t.easing["easeInOut" + e] = (t) =>
              0.5 > t ? i(2 * t) / 2 : 1 - i(-2 * t + 2) / 2);
        });
    })();
  var f = t.effects;
  ...
  t.uiBackCompat !== !1 &&
    ...
    t.extend(t.expr[":"], {
      focusable: (e) => t.ui.focusable(e, null != t.attr(e, "tabindex")),
    }),
    t.ui.focusable,
    (t.fn.form = function () {
    ...
    t.widget("ui.menu", {
      ...
      _closeOnDocumentClick: (e) => !t(e.target).closest(".ui-menu").length,
      _isDivider: (t) => !/[^\-\u2014\u2013\s]/.test(t.text()),
      collapse: function (t) {
        var e =
          this.active &&
    ...
    t.widget("ui.autocomplete", {
      ...
      _renderItem: (e, i) =>
        t("<li>").append(t("<div>").text(i.label)).appendTo(e),
      _move: function (t, e) {
      ...
      this._addClass(
        ...
        e.length &&
          (t.each(["first", "last"], (t, s) => {
            ...
            if (n && this["_" + n.widgetName + "Options"]) {
              var o = this["_" + n.widgetName + "Options"](
                1 === e.length ? "only" : s,
              );
              (o.classes = this._resolveClassesValues(o.classes, n)),
                n.element[n.widgetName](o);
            } else this._updateCornerClass(e[s](), s);
          }),
  ...
  t.extend(s.prototype, {
        ...
        "input" === i
          ...
          : ("div" === i || "span" === i) &&
            ...
            s
              ...
              .prop("disabled", !1)),
        (this._disabledInputs = t.map(this._disabledInputs, (t) =>
          t === e ? null : t,
        )));
    },
    ...
    _daylightSavingAdjust: (t) =>
      t ? (t.setHours(t.getHours() > 12 ? t.getHours() + 2 : 0), t) : null,
    ...
    _getFirstDayOfMonth: (t, e) => new Date(t, e, 1).getDay(),
  ...
  t(document).on("mouseup", () => {
    ...
    t.widget("ui.mouse", {
      ...
      _mouseInit: function () {
        this.element
          .on("mousedown." + this.widgetName, (t) => this._mouseDown(t))
            ...
            ? ((this.mouseDelayMet = !this.options.delay),
              ...
              !this._mouseStarted)
                ...
                : (!0 ===
                  ...
                  (this._mouseMoveDelegate = (t) => this._mouseMove(t)),
                  (this._mouseUpDelegate = (t) => this._mouseUp(t)),
                  this.document
    ...
    t.widget("ui.resizable", t.ui.mouse, {
      ...
      _num: (t) => parseFloat(t) || 0,
      _isNumber: (t) => !isNaN(parseFloat(t)),
      _hasScroll: (e, i) => {
        ...
        this._addClass("ui-resizable"),
          ...
          i.autoHide &&
            t(this.element)
              .on("mouseenter", () => {
                i.disabled ||
                  (this._removeClass("ui-resizable-autohide"),
                  this._handles.show());
              })
              .on("mouseleave", () => {
                i.disabled ||
    ...
    t.widget("ui.dialog", {
      ...
      _setOptions: function (e) {
        ...
        t.each(e, (t, e) => {
          this._setOption(t, e),
            t in this.sizeRelatedOptions && (s = !0),
            t in this.resizableRelatedOptions && (n[t] = e);
        }),
    ...
    t.widget("ui.droppable", {
      ...
      _create: function () {
        ...
        (this.isover = !1),
          (this.isout = !0),
          (this.accept = t.isFunction(s) ? s : (t) => t.is(s)),
      ...
      _setOption: function (e, i) {
        if ("accept" === e) this.accept = t.isFunction(i) ? i : (t) => t.is(i);
        else if ("scope" === e) {
  ...
  (t.ui.ddmanager = {
    ...
    t.widget("ui.selectmenu", [
      t.ui.formResetMixin,
      {
        ...
        _drawButton: function () {
          ...
          (this.labels = this.element.labels().attr("for", this.ids.button)),
            ...
            this.button.one("focusin", () => {
              this._rendered || this._refreshMenu();
            });
        },
        _drawMenu: function () {
          (this.menu = t("<ul>", {
            ...
            (this.menuInstance = this.menu
              .menu({
                ...
                select: (t, i) => {
                  t.preventDefault(),
                    this._setSelection(),
                    this._select(i.item.data("ui-selectmenu-item"), t);
                },
                focus: (t, i) => {
                  var s = i.item.data("ui-selectmenu-item");
                  null != this.focusIndex &&
                    s.index !== this.focusIndex &&
                    (this._trigger("focus", t, { item: s }),
                    this.isOpen || this._select(s, t)),
                    (this.focusIndex = s.index),
                    this.button.attr(
                      "aria-activedescendant",
                      this.menuItems.eq(s.index).attr("id"),
                    );
                },
              })
              .menu("instance")),
        ...
        _parseOptions: function (e) {
          var s = [];
          e.each((e, n) => {
            s.push(this._parseOption(t(n), e));
          }),
            (this.items = s);
        },
        _parseOption: (t, e) => {
    ...
    t.widget("ui.tabs", {
        ...
        (this.tablist = this._getList().attr("role", "tablist")),
          ...
          this.anchors.each((i, s) => {
            ...
            this._isLocal(s)
              ? ((n = s.hash),
                (a = n.substring(1)),
                (o = this.element.find(this._sanitizeSelector(n))))
              : ((a = h.attr("aria-controls") || t({}).uniqueId()[0].id),
                (n = "#" + a),
                (o = this.element.find(n)),
                o.length ||
                  ((o = this._createPanel(a)),
                  o.insertAfter(this.panels[i - 1] || this.tablist)),
                o.attr("aria-live", "polite")),
              o.length && (this.panels = this.panels.add(o)),
      ...
      _createPanel: (e) => t("<div>").attr("id", e).data("ui-tabs-destroy", !0),
      ...
      load: function (e, i) {
        e = this._getIndex(e);
        var n = this.tabs.eq(e),
          o = n.find(".ui-tabs-anchor"),
          a = this._getPanelForTab(n),
          r = { tab: n, panel: a },
          h = (t, e) => {
            "abort" === e && this.panels.stop(!1, !0),
              this._removeClass(n, "ui-tabs-loading"),
              a.removeAttr("aria-busy"),
              t === this.xhr && delete this.xhr;
          };
        this._isLocal(o[0]) ||
          ...
          this.xhr &&
            ...
            this.xhr
              .done((t, e, n) => {
                setTimeout(() => {
                  a.html(t), this._trigger("load", i, r), h(n, e);
                }, 1);
              })
              .fail((t, e) => {
                setTimeout(() => {
